...
(function() {
  this.Dosbox = (function() {
    ...
    Dosbox.prototype.run = function(archiveUrl, executable) {
      return new Dosbox.Mount(this.module, archiveUrl, {
        success: (function(_this) {
          return function() {
            var func, hide;
            _this.ui.updateMessage("Ejecutando... " + executable);
            hide = function() {
        ...
        progress: (function(_this) {
          return function(total, current) {
            return _this.ui.updateMessage("Montando .exe " + executable + " (" + (current * 100 / total | 0) + "%)");
          };
        })(this)
      });
    };
    ...
    Dosbox.prototype.downloadScript = function() {
      this.module.setStatus('Descargando js-dos...');
      this.ui.updateMessage('Descargando js-dos...');
      return new Dosbox.Xhr('https://hamzab0ce.github.io/DOOM-Online/js-dos-v3.js', {
        success: (function(_this) {
          return function(script) {
            var func;
            _this.ui.updateMessage('Iniciando DOSBox');
            func = function() {
        ...
        progress: (function(_this) {
          return function(total, current) {
            return _this.ui.updateMessage("Descargando js-dos... (" + (current * 100 / total | 0) + "%)");
          };
        })(this)
      });
    };
...
(function() {
  Dosbox.Module = (function() {
    ...
    Module.prototype.monitorRunDependencies = function(left) {
      ...
      status = left ? "Preparando... (" + (this.totalDependencies - left) + "/" + this.totalDependencies + ")" : 'Todas las descargas completadas.';
        ...
        success: (function(_this) {
          return function(data) {
            ...
            if (_this._mountZip(bytes)) {
              ...
              return typeof console !== "undefined" && console !== null ? typeof console.error === "function" ? console.error('no a sido posible montar', url) : void 0 : void 0;
            }
          };
        })(this),
...
(function() {
  Dosbox.UI = (function() {
    function UI(options) {
      ...
      this.start = $('<div class="dosbox-start">Click para iniciar.');
      ...
      // Ajustar tamaño del canvas a 800x600
